(async function() {
  ...
  // Automatically create the container right where the script tag is placed
  const container = document.createElement('div');
  container.className = 'aen-widget-container';
  ...
  try {
    ...
    container.style.cssText = "border:1px solid #38bdf8;padding:16px;border-radius:8px;background:#1e293b;color:#fff;font-family:sans-serif;max-width:300px;margin:10px 0;";
